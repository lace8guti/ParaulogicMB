...
-- Tiempo de generación: 11-05-2023 a las 20:04:41
...
--
-- Base de datos: `ParaulogicMBFinal3`
--
CREATE DATABASE IF NOT EXISTS `ParaulogicMBFinal3` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `ParaulogicMBFinal3`;
...
ALTER TABLE `challenges`
  ...
  ADD CONSTRAINT `fk_challenges_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `daily_scores`
  ...
  ADD CONSTRAINT `fk_daily_scores_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
